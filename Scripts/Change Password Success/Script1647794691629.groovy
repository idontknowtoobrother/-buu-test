...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_My ID/input_(New Password)_newpass'), 'olAd+JjIcWVsTzDMdIPb2w==')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_My ID/input_(Re-New Password)_renewpass'), 'olAd+JjIcWVsTzDMdIPb2w==')

WebUI.click(findTestObject('Object Repository/Page_My ID/button_Change Password'))

text = WebUI.getText(findTestObject('Object Repository/Page_My ID/div_Change password successfully'))

Assert.assertEquals('เปลี่ยนรหัสผ่านสำเร็จ\n\n' + 'Change password successfully.', text)
