...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_My ID/input_(Password)_pass'), 'DDp/Ia9hklqrXsxDFIE4WQ==')

WebUI.click(findTestObject('Object Repository/Page_My ID/button_Sign in'))

url = WebUI.getUrl()

Assert.assertEquals('https://myid.buu.ac.th/signin/1', url)
