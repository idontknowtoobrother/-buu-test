...
WebUI.click(findTestObject('Object Repository/Page_My ID/input_(Username)_user'))
...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_My ID/input_(New Password)_newpass'), 'RigbBhfdqOClIW1t6QAV7dgmZY0QyMftoal+SZAFG3U=')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_My ID/input_(Re-New Password)_renewpass'), 'RigbBhfdqOClIW1t6QAV7dgmZY0QyMftoal+SZAFG3U=')

WebUI.click(findTestObject('Object Repository/Page_My ID/button_Change Password'))

text = WebUI.getText(findTestObject('Object Repository/Page_My ID/div_Not found characters in your new password'))

Assert.assertEquals('ไม่พบตัวอักษรภาษาอังกฤษ ในรหัสผ่านใหม่ของท่าน\n' + 'Not found characters in your new password', text)
