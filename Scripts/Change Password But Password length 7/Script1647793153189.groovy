...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_My ID/input_(New Password)_newpass'), 'qeJ0sjJnwEs=')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_My ID/input_(Re-New Password)_renewpass'), 'qeJ0sjJnwEs=')

WebUI.click(findTestObject('Object Repository/Page_My ID/button_Change Password'))

text = WebUI.getText(findTestObject('Object Repository/Page_My ID/div_8   25 Password more than 8 - 25 character'))

Assert.assertEquals(('รหัสผ่านของท่าน\n' + 'ต้องมีความยาวขั้นต่ำ 8 ตัวอักษร แต่ไม่เกิน 25 ตัวอักษร\n') + 'Password more than 8 - 25 character', 
    text)
