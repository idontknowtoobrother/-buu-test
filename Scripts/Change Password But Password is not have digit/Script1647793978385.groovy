...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_My ID/input_(New Password)_newpass'), 'SaLzXmhNQh+IxjDd6mTgAQ==')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_My ID/input_(Re-New Password)_renewpass'), 'SaLzXmhNQh+IxjDd6mTgAQ==')

WebUI.click(findTestObject('Object Repository/Page_My ID/button_Change Password'))

text = WebUI.getText(findTestObject('Object Repository/Page_My ID/div_Not found number in your new password'))

Assert.assertEquals('ไม่พบตัวเลข ในรหัสผ่านใหม่ของท่าน\n' + 'Not found number in your new password', text)
